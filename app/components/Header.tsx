 ...
 * 
 * Copilot helped with responsive design patterns and Tailwind CSS classes
...
const Header: React.FC = () => {
  ...
  // Copilot suggested state management pattern for mobile menu
  const toggleMenu = () => {
    ...
    <header className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 shadow-lg transition-colors duration-200 relative">
      <div className="container mx-auto flex justify-between items-center px-8 py-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          {/* ChatGPT helped with accessibility attributes and ARIA labels */}
          <button
            onClick={toggleMenu}
          ...
          >
            {/* Copilot suggested CSS transform animations for hamburger icon */}
            <span 
